    ...
    <>
      <Box sx={{ width: "80vw", mx: "auto", my: 8 }}>
        <Box component="div" sx={{ py: 4, textAlign: "center" }}>
          <TextAnimation
            text={"Discover our district fellowships"}
            variant="h3"
            color="text.primary"
          />
          <TextAnimation
            text={
              "Our district fellowships take place every week on Thursday from 7pm to 8pm usually at one of the members residence.These are our districts and their patrons."
            }
            gutterBottom
            variant="body2"
            color="text.primary"
        ...
        <TableContainer sx={{ maxHeight: 440 }} component={Paper} elevation={6}>
